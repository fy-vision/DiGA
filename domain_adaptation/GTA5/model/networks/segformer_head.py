...
import mmcv
from mmcv.cnn import ConvModule, normal_init, DepthwiseSeparableConvModule
import warnings
...
class SegFormerHead(nn.Module):
    ...
    """
    def __init__(self, in_channels=None, channels=None, feature_strides=None, num_classes=None, in_index=None, act_cfg=dict(type='ReLU'), dropout_ratio=0.1, conv_cfg=None,
                 norm_cfg=None, input_transform='multiple_select', align_corners=False, **kwargs):
    ...
    def init_weights(self):
        ...
        normal_init(self.linear_pred, mean=0, std=0.01)
    ...
    def forward(self, inputs):
        ...
        _c_raw = torch.cat([_c4, _c3, _c2, _c1], dim=1)
        _c = self.linear_fuse(_c_raw)
...
class DAFormerHead(nn.Module):
    def __init__(self, in_channels=None, channels=None, feature_strides=None, num_classes=None, in_index=None,
                 act_cfg=None, dropout_ratio=None, conv_cfg=None,
                 norm_cfg=None, input_transform='multiple_select', align_corners=False):
        ...
        decoder_params = dict(embed_cfg=dict(type='mlp', act_cfg=None, norm_cfg=None),
        ...
        self.conv_seg = nn.Conv2d(self.channels, self.num_classes, kernel_size=conv_kernel_size)
    ...
    def forward(self, inputs):
        ...
        feat_raw = torch.cat(list(_c.values()), dim=1)
        feat = self.fuse_layer(feat_raw)
        x = self.cls_seg(feat)
