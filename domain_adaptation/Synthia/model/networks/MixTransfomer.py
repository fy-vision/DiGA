...
#sys.path.append('/home/gitlab_/area51/app/SemanticSegmentation/SegFormer-master/')
...
class MixVisionTransformer(nn.Module):
    ...
    def init_weights(self, pretrained_weights_path=''):
        ...
        if os.path.isfile(pretrained_weights_path):
            ...
            print('MiT weights initialized with IMAGENET-1k pretrained weights!')

        else:
            print('MiT weights randomly initialized!')
    '''
