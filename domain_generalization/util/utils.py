...
def poly_lr_scheduler_warm(base_lr, iter, warmup = 1500, max_iter=80000, power=1.0):
    if iter<=warmup:
...
def update_teacher_params(teacher, student, iteration, stage0=True, mean=False, replace=False):
