...
DATA_LIST_PATH_TRAIN_IMG = './util/loader/cityscapes_list/split_train/train_image_unlabeled_1-16.txt'
DATA_LIST_PATH_TRAIN_LBL  = './util/loader/cityscapes_list/split_train/train_label_unlabeled_1-16.txt'
...
for index, batch in enumerate(train_loader):
    ...
    with torch.no_grad():
        _, _, output_ds, _ = student(Variable(image_ds).cuda()[:,[2, 1, 0],:,:])
        _, _, output, _ = student(Variable(image).cuda()[:,[2, 1, 0],:,:])
